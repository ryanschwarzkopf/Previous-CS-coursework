...
public class BST {
	...
	/**
	 * inserts a new node into the bst. Data is valid according
	 * to the invariant
	 * 
	 * @param e: the data to be inserted
	 * @postcondition bst is valid
	 * @return
	 */
	 ...
	 * This method is pretty slow, it uses the brute force
	 * 
	 * @param e: data to be removed
	 * @return true: node was removed, false: node wasn't there
	 */
	...
	/**
	 * search recursion searches down a bst by moving down and searching a smaller tree
	 * If bst is null, returns null
	 * 
	 * @param e: data to be searched for
	 * @return BSTNode with data e
	 */
	...
	/**
	 * search non recursion searches down a bst
	 * If bst is null, returns null
	 * 
	 * @param e: data to be searched for
	 * @return BSTNode with data e
	...
	/**
	 * kthLargestNode returns the kth largest element in a bst.
	 * 
	 * @param init
	 * @param k: Kth largest value. (Cannot be 0)
	 * @precondition 0 < k <= init.size
	 * @precondition static elementCountK must be set to 0 before calling this function.
	 * @return
	 */
